package com.comp.tasker.security;
...
import com.comp.tasker.constants.Constants;
...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		try {
			com.comp.tasker.model.User user = getUserDetail(username);
	...
	private com.comp.tasker.model.User getUserDetail(String email) throws Exception {
		com.comp.tasker.model.User user = userDao.findByEmail(email);
		if (user == null) {
